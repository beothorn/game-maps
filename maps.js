...
let maps = [
  ...
  [
    ...
    [
      // world 1 level 1
      "TtTttTtTtTTtttTTtTTttTtTtTTttTTTTrrc",
      "t          T k T k T k T k T k tTc",
      "t          T   T   T   T   T   tTc",
      "T     t      T   T   T   T   r  TTc",
      "T     tT      T   T   T   T      TTc",
      "T       tT                  r        c",
      "T       tt                           c",
      "t  2   tTtTtTtttTttttTttT    pp    ttTTc",
      "Tt   ttTtTtTtttTttttTttT      pp ttTTc",
      "ttTtttTtTTtTtTTttTtTtTT        pp     c",
      "ttTtttTtTTtTTTtTtttTTTTT        pp     c",
      "TTtTtTtTtttTTtTTttTtTtTTtttT    pp      c",
      "TTtTtttTTTtTtttTtttT    Gk      pp       c",
      "TTtTtttTTTttTTtTTttTtTtTTtttT gg  pp      c",
      "T     TTtTtttTTTTTtTtttTTTTTTtTt   ggg    c",
      "t                k                         c",
      "T     +++++++++++    gggggg    www           c",
      "T     +          +     ggg    wwwww           c",
      "t     +           +    ggggg        www        c",
      "T                  ++   Gg G G +++++++++++++++++c",
      "T                                                c",
      "TTtTttTtTTtTttTTTtttttTtTTtTtttTTT   tT  tT Ttt   +c",
      "T           ggggggggggggggg                          c",
      "TttTTTtTttT       tTt   gg   ttTtTt     t    ggg     kc",
      "T  G T  k  T      ttT   gg  TtT        TTT    gwg       kc",
      "T  k t     T      TtT   g    tTT        TtT    w       kc",
      "T                 TtT       TTT        TtT      tTtTk k k k k T",
      "tTTTttttTtTtTTttTTTtT   1   TTtTTtTtTTttTTTtTTtTTtTtTTtTTTTttTT",
      "TTtTTtTtTTtTTTTtTTtTTtTtTTttTTTtTTtTTtTtTTtTTTTtTTtTTtTtTTtTTTT"
    ],
    [
      // world 1 level 2
